...
ditto -c -k --keepParent "release_preset_maker/Passport creator-arm64.app" "release_preset_maker/Passport creator-arm64.zip"

echo "Built release_preset_maker/Passport creator-arm64.zip"
